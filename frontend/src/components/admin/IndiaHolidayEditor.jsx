...
const IndiaHolidayEditor = () => {
  ...
  const loadData = async () => {
    try {
      ...
      setPackages(allPackages.filter(pkg => pkg.region === 'india' || pkg.region === 'both'));
    } catch (error) {
  ...
  const handleSave = async () => {
    try {
      setSaving(true);
      await holidayPagesAPI.update('india', config);
      alert('India Holiday Page configuration saved successfully!');
    } catch (error) {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">🇮🇳 India Holiday Page</h2>
                ...
                <div>
                  <label className="block text-sm font-medium mb-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      data-testid="india-banner-desktop-gallery-btn"
                    >
                  ...
                  <input
                    ...
                    placeholder="https://..."
                    data-testid="india-banner-desktop-input"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-blue-600 hover:text-blue-800 flex items-center space-x-1 text-xs"
                      data-testid="india-banner-mobile-gallery-btn"
                    >
                      <ImageIcon className="h-4 w-4" />
                      <span>Browse Gallery</span>
                    </button>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border rounded"
                    placeholder="https://..."
                    data-testid="india-banner-mobile-input"
                  />
                </div>
              </div>
                ...
                <>
                  ...
                  <div>
                    ...
                    <div className="max-h-96 overflow-y-auto border rounded p-4 space-y-2">
                      ...
                      {packages.length === 0 && (
                        <p className="text-center text-gray-500 py-4">No India packages available</p>
                      )}
                    </div>
                  </div>
                </>
...
export default IndiaHolidayEditor;
